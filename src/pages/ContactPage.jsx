          ...
          <div className="contact-page__items">
            <div className="contact-page__item">
              ...
              <div>
                ...
                <a href="mailto:mjmukthar96@gmail.com" className="contact-page__value">
                  mjmukthar96@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="contact-page__item">
              ...
              <div>
                <p className="contact-page__label">LinkedIn</p>
                <a
